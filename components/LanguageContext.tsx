...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'github': 'GitHub',
    'email': 'Email',
    'redirect_notice': 'Automatically redirected to new URL',
    'visits': 'Visits',
    'visitors': 'Visitors',
    'sample_count': 'Sample Count',
    'star_request': 'If you find this useful, please give it a ⭐ on GitHub!',
    'history': 'History',
    'no_history': 'No history yet',
    'history_notice': 'Will be saved after viewing a report',
